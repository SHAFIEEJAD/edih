...
function submit() {
    router.post('/dashboard/email/store', form)
}
...
<Head title="Create Email" />
    ...
    <Layout>
        ...
        <form @submit.prevent="submit" class="row g-3 mt-3">
            ...
            <div class="mb-3 col-6 sm-col-12">
                <label for="name" class="form-label">Carbon Copy Email Addresses (CC)</label>

                <TagsInput  @update:cc_addresses_list="updateCcAddressesList" />
